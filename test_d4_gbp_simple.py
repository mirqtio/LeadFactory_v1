...
def run_simple_tests():
    ...
    try:
        ...
        async def run_async_tests():
            ...
            confidence_score = enricher._calculate_confidence_score(business_data, sample_gbp)
            ...
            batch_enricher = BatchGBPEnricher(enricher=enricher, max_concurrent=2, batch_size=3)
            businesses = [
            ...
            assert enricher._extract_domain("https://www.example.com/path") == "example.com"
