...
class SpamScoreChecker:
    ...
    def _get_fallback_rules(self) -> List[SpamRule]:
        ...
        return [
            SpamRule("word_free", SpamRuleType.KEYWORD, "Word: FREE", r"\bfree\b", 15.0, category="keywords"),
            SpamRule("word_urgent", SpamRuleType.KEYWORD, "Word: URGENT", r"\burgent\b", 12.0, category="keywords"),
            SpamRule("all_caps", SpamRuleType.PATTERN, "All caps words", r"\b[A-Z]{4,}\b", 8.0, category="formatting"),
            SpamRule("multiple_exclamation", SpamRuleType.PATTERN, "Multiple exclamations", r"!{2,}", 10.0, category="formatting"),
            SpamRule("subject_too_long", SpamRuleType.LENGTH, "Subject line too long", "", 5.0, threshold=60.0, category="structure")
        ]
