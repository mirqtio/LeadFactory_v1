...
def upgrade() -> None:
    ...
    op.create_table('batch_reports',
        ...
        sa.Column('status', sa.Enum('PENDING', 'RUNNING', 'COMPLETED', 'FAILED', 'CANCELLED', name='batchstatus'), nullable=False, default='PENDING'),
    ...
    op.create_table('batch_report_leads',
        ...
        sa.Column('status', sa.Enum('PENDING', 'PROCESSING', 'COMPLETED', 'FAILED', 'SKIPPED', name='leadprocessingstatus'), nullable=False, default='PENDING'),
