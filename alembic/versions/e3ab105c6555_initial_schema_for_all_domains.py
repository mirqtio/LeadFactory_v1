...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("DRAFT", "ACTIVE", "PAUSED", "COMPLETED", name="experimentstatus"),
            nullable=True,
        ),
    ...
    op.create_index(
        "idx_gateway_usage_provider_created",
        "gateway_usage",
        ["provider", "created_at"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "geo_type",
            sa.Enum("ZIP", "CITY", "METRO", "STATE", name="geotype"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "RUNNING", "COMPLETED", "FAILED", name="batchstatus"),
            nullable=True,
        ),
        sa.Column("started_at", sa.TIMESTAMP(), nullable=True),
        sa.Column("completed_at", sa.TIMESTAMP(), nullable=True),
    ...
    op.create_index(
        "idx_scoring_business_created",
        "scoring_results",
        ["business_id", "created_at"],
        unique=False,
    )
    op.create_index(
        "idx_scoring_tier_created",
        "scoring_results",
        ["tier", "created_at"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column("aggregation_period", sa.String(), nullable=False),
    ...
    op.create_index("idx_metrics_aggregations_metric_name", "metrics_aggregations", ["metric_name"], unique=False)
    op.create_table(
        "time_series_data",
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index("ix_time_series_data_metric_name_timestamp", table_name="time_series_data")
    op.drop_index("ix_time_series_data_timestamp", table_name="time_series_data")
