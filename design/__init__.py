    ...
    def __init__(self, color_data: Dict[str, Any]):
        for name, data in color_data.items():
            ...
            if isinstance(data, dict):
                setattr(self, attr_name, ColorToken(
...
typography = type('Typography', (), {
    ...
    'scale': TypographyScale(tokens['typography']['scale'])
})()

spacing = type('Spacing', (), {
    'base': tokens['spacing']['base'],
    'scale': SpacingScale(tokens['spacing']['scale'])
})()
...
def validate_tokens() -> bool:
    ...
    required_structure: Dict[str, Any] = {
        ...
        'typography': {
            'scale': 9       # Expected number of typography scales
        },
        'spacing': {
            'scale': 7       # Expected number of spacing scales
        },
        'animation': {
            'duration': 4    # Expected number of animation durations
        },
