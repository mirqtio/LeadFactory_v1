    ...
    def _get_default_rates(self) -> Dict:
        ...
        return {
            "report_generation": {
                ...
                "complexity_multiplier": {"simple": 1.0, "standard": 1.5, "comprehensive": 2.0},
            },
            "providers": {
                "dataaxle": {"per_lead": 0.15, "confidence_threshold": 0.75},
                "hunter": {"per_lead": 0.10, "confidence_threshold": 0.85},
                "openai": {"per_assessment": 0.25, "per_1k_tokens": 0.002},
                "semrush": {"per_domain": 0.08},
                "pagespeed": {"per_analysis": 0.03},
                "screenshotone": {"per_screenshot": 0.02},
            },
            "discounts": {
                "volume_tiers": {
...
class CostCalculator:
    ...
    def _estimate_duration(self, lead_count: int, template_version: str) -> int:
        ...
        base_minutes_per_lead = {"simple": 0.5, "standard": 1.0, "comprehensive": 1.5, "v1": 1.0}  # Default
    ...
    def validate_budget(self, total_cost: float, daily_budget_override: Optional[float] = None) -> Dict:
        ...
        try:
            ...
            if total_cost > remaining_budget:
                validation[
                    "warning_message"
                ] = f"Batch cost ${total_cost:.2f} exceeds remaining daily budget ${remaining_budget:.2f}"
