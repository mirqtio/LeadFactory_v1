...
class AuthService:
    ...
    def generate_access_token(user_id: str, email: str) -> str:
        ...
        expire = datetime.now(timezone.utc) + timedelta(
            minutes=AuthService.JWT_ACCESS_TOKEN_EXPIRE_MINUTES
        )
        payload = {
            "sub": user_id,
            "email": email,
    ...
    def generate_refresh_token(user_id: str) -> str:
        ...
        """
        expire = datetime.now(timezone.utc) + timedelta(
            days=AuthService.JWT_REFRESH_TOKEN_EXPIRE_DAYS
        )
        payload = {
            "sub": user_id,
            "exp": expire,
    ...
    def verify_email_token(
        ...
        # Update user
        user = db.query(AccountUser).filter(
            AccountUser.id == verification.user_id
        ).first()
