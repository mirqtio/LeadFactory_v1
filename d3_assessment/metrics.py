...
# System info
assessment_system_info = Info("assessment_system", "Assessment system information")
assessment_system_info.info({"version": "1.0.0", "environment": "production"})
...
class AssessmentMetrics:
    ...
    def track_cache_hit(self, assessment_type: AssessmentType):
        """Track cache hit"""
        assessment_cache_hits.labels(assessment_type=assessment_type.value).inc()

    def track_cache_miss(self, assessment_type: AssessmentType):
        """Track cache miss"""
        assessment_cache_misses.labels(assessment_type=assessment_type.value).inc()
...
class AssessmentMetricsCollector:
    ...
    def export_to_json(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "metrics": summary,
            "system": {"version": "1.0.0", "uptime_seconds": summary["uptime_seconds"]},
        }
