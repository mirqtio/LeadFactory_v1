...
Extracts Core Web Vitals, scores, and performance issues with
...
class PageSpeedAssessor:
    ...
    Handles comprehensive website performance analysis using Google PageSpeed
    Insights, extracting Core Web Vitals, performance scores, and
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        # Mobile-first approach per acceptance criteria
...
class PageSpeedBatchAssessor:
    ...
    Handles efficient processing of multiple URLs with rate limiting and
    error handling.
    """
