...
class YelpSearchFieldsAssessor(BaseAssessor):
    ...
    async def assess(self, url: str, business_data: Dict[str, Any]) -> AssessmentResult:
        ...
        try:
            ...
            if 'raw_data' in business_data and isinstance(business_data['raw_data'], dict):
                ...
                if raw_yelp:
                    ...
                    yelp_data['photos'] = raw_yelp.get('photos', [])[:3]  # Limit to 3 photos
    ...
    def _extract_categories(self, business_data: Dict[str, Any]) -> List[Dict[str, str]]:
