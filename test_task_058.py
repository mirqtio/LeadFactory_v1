...
from d7_storefront.schemas import (APIStatusResponse,
...
def test_task_058():
    ...
    request_data = {
        ...
        "additional_metadata": {"referrer": "partner_site"},
    }
    ...
    webhook_response_data = {
        ...
        "data": {
            ...
            "report_generation": {"status": "triggered", "job_id": "report_job_123"},
        },
    }
    ...
    error_data = {
        ...
        "details": {"field": "customer_email", "provided_value": "invalid-email"},
    ...
    for test_case in test_cases:
        try:
            ...
            if test_case["should_fail"]:
                assert (
                    False
                ), f"Test case '{test_case['name']}' should have failed validation"
        except Exception as e:
            if not test_case["should_fail"]:
                assert (
                    False
                ), f"Test case '{test_case['name']}' should have passed validation: {e}"
    ...
    audit_request_data = {
        ...
        "amount_usd": 29.99,
        "attribution_data": {"utm_source": "google", "utm_campaign": "audit_reports"},
    }
    ...
    bulk_request_data = {
        ...
        "attribution_data": {"utm_source": "google", "utm_campaign": "bulk_audits"},
    }
