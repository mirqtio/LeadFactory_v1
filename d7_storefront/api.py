...
from .schemas import (
    ...
    CheckoutSessionStatusRequest, CheckoutSessionStatusResponse,
...
from .checkout import CheckoutManager, CheckoutSession, CheckoutItem, CheckoutError
from .webhooks import WebhookProcessor, WebhookError, WebhookStatus
...
async def stripe_webhook(
    ...
    try:
        ...
        if result["success"]:
            ...
            if (result.get("event_type") == "checkout.session.completed" and 
                result.get("data", {}).get("payment_status") == "paid"):
    ...
    try:
        ...
        if payment_successful:
            ...
            return SuccessPageResponse(
                ...
                amount_total_usd=session_data.get("amount_total", 0) / 100.0 if session_data.get("amount_total") else None,
