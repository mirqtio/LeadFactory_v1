...
from sqlalchemy import (
    ...
    DECIMAL, JSON, TIMESTAMP, Enum as SQLEnum
)
...
class Purchase(Base):
    ...
    business_id = Column(String, ForeignKey("businesses.id"), nullable=True)  # Optional - may be purchase before business selection
...
class PurchaseItem(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("total_price_cents = unit_price_cents * quantity", name="check_total_calculation"),
    )
