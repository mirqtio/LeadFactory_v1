...
from .models import Purchase, PaymentSession, Customer, PurchaseStatus, PaymentMethod
from .webhooks import WebhookStatus, WebhookError
        ...
        try:
            ...
            if purchase_id:
                ...
                if customer_email:
                    ...
                    generation_result = {"status": ReportGenerationStatus.SKIPPED.value, "reason": "No customer email"}
            else:
                generation_result = {"status": ReportGenerationStatus.SKIPPED.value, "reason": "No purchase ID"}
