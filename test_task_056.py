...
from d7_storefront.stripe_client import (
    StripeClient, StripeConfig, StripeCheckoutSession, 
    create_one_time_line_item, format_amount_for_stripe
)
from d7_storefront.checkout import (
    CheckoutManager, CheckoutSession, CheckoutItem, CheckoutConfig,
...
def test_task_056():
    ...
    items = [
        CheckoutItem("Website Audit Report", Decimal("29.99"), product_type=ProductType.AUDIT_REPORT),
        CheckoutItem("Premium Analysis", Decimal("99.99"), product_type=ProductType.PREMIUM_REPORT)
    ]
