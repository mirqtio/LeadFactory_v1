...
from d7_storefront.webhook_handlers import (CheckoutSessionHandler,
                                            CustomerHandler, InvoiceHandler,
...
def test_task_057():
    ...
    bulk_result = checkout_handler.handle_session_completed(
        mock_bulk_event_data, "evt_bulk_123"
    )
    ...
    invoice_result = invoice_handler.handle_invoice_event(
        "invoice.payment_succeeded", invoice_event, "evt_invoice_123"
    )
