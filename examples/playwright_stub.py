...
def capture_lighthouse_metrics(url: str) -> dict:
    ...
    with sync_playwright() as p:
        ...
        metrics = {
            ...
            "title": page.title(),
            "performance": {
                "domContentLoaded": page.evaluate("window.performance.timing.domContentLoadedEventEnd - window.performance.timing.navigationStart"),
                "loadComplete": page.evaluate("window.performance.timing.loadEventEnd - window.performance.timing.navigationStart")
            },
            "lighthouse": {
