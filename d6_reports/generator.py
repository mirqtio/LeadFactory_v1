...
class ReportGenerator:
    ...
    async def generate_report(self, 
        ...
        try:
            ...
            logger.error(f"Report generation error for business {business_id}: {e}", exc_info=True)
    ...
    async def _generate_report_internal(self, 
                                      business_id: str, 
    ...
    async def batch_generate(self, business_ids: List[str], options: Optional[GenerationOptions] = None) -> List[GenerationResult]:
        """
        ...
        tasks = [
            self.generate_report(business_id, options)
