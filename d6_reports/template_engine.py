...
<body>
    ...
    def create_template_data(self,
                           ...
                           metadata: Dict[str, Any] = None) -> TemplateData:
        """
...
# Utility functions
def create_basic_template_data(business_name: str, 
                             performance_score: int = 75,
                             accessibility_score: int = 80,
                             seo_score: int = 70) -> TemplateData:
    """Create basic template data for testing"""
    return TemplateData(
        business={"name": business_name, "url": f"https://{business_name.lower().replace(' ', '')}.com"},
        assessment={
