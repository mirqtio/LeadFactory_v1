...
def check_ci_status():
    ...
    test_results = {"unit_tests": False, "integration_tests": False, "linting": False, "overall": False}
    ...
    # Overall status
    test_results["overall"] = all([test_results["unit_tests"], test_results["linting"]])
