...
"""
    ...
    # Test GBP flag
    if run_command("USE_STUBS=true pytest tests/unit/d0_gateway/test_provider_flags.py::TestProviderFeatureFlags::test_google_places_respects_enable_flag -xvs -q"):
    ...
    # Test PageSpeed flag
    if run_command("USE_STUBS=true pytest tests/unit/d0_gateway/test_provider_flags.py::TestProviderFeatureFlags::test_pagespeed_respects_enable_flag -xvs -q"):
    ...
    # Test SendGrid flag
    if run_command("USE_STUBS=true pytest tests/unit/d0_gateway/test_provider_flags.py::TestProviderFeatureFlags::test_sendgrid_respects_enable_flag -xvs -q"):
    ...
    # Test OpenAI flag
    if run_command("USE_STUBS=true pytest tests/unit/d0_gateway/test_provider_flags.py::TestProviderFeatureFlags::test_openai_respects_enable_flag -xvs -q"):
    ...
    if run_command("USE_STUBS=true pytest tests/unit/core/test_config.py::TestEnvironmentConfiguration::test_provider_flags_auto_disable_with_stubs -xvs -q"):
    ...
    if run_command("USE_STUBS=true pytest tests/unit/core/test_config.py::TestEnvironmentConfiguration::test_api_key_validation_when_providers_enabled -xvs -q"):
    ...
    if run_command("USE_STUBS=true pytest tests/unit/core/test_config.py tests/unit/d0_gateway/test_provider_flags.py tests/integration/test_stub_server.py -xvs -q"):
...
"""
    ...
    if run_command("pytest tests/unit/core/test_config.py tests/unit/d0_gateway/test_provider_flags.py --cov=core.config --cov-report=term-missing --cov-fail-under=80 -q"):
