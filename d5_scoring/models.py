...
class ScoreBreakdown(Base):
    ...
    id = Column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    scoring_result_id = Column(String(36), ForeignKey("scoring_results.id"), nullable=False)
...
class ScoringEngine:
    ...
    def _extract_component_data(self, component: ScoreComponent, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        field_mappings = {
            ...
            ScoreComponent.SOCIAL_SIGNALS: ['rating', 'reviews_count', 'social_mentions'],
    ...
    def _calculate_data_completeness(self, data: Dict[str, Any]) -> float:
        ...
        key_fields = [
            ...
            'employee_count', 'annual_revenue', 'business_status'
        ]
