...
from .constants import FORMULA_EVALUATION_TIMEOUT, FORMULA_CACHE_SIZE

logger = get_logger(__name__)

# Metrics
formula_evaluation_time = Histogram(
    'formula_evaluation_duration_seconds',
    'Time spent evaluating formulas',
    ['formula_type']
)

formula_errors = Counter(
    'formula_evaluation_errors_total',
...
class FormulaEvaluator:
    ...
    def evaluate(
        ...
        formula: str,
        data: Dict[str, Any],
        timeout: float = FORMULA_EVALUATION_TIMEOUT
        ...
        try:
            ...
            logger.error(f"Formula evaluation error: {e}", extra={
                "formula": formula,
