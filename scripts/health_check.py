...
class HealthChecker:
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.config = config or {
            ...
            'database_url': os.getenv('DATABASE_URL', 'postgresql://leadfactory:password@localhost:5432/leadfactory'),
    ...
    def check_docker_services(self) -> bool:
        ...
        try:
            ...
            result = subprocess.run(
                ['docker-compose', '-f', 'docker-compose.production.yml', '-p', 'leadfactory', 'ps'],
                capture_output=True,
                text=True,
                timeout=30
            )
    ...
    def run_all_checks(self, services: List[str] = None) -> bool:
        ...
        all_services = [
            'api', 'database', 'redis', 'prometheus', 'grafana', 'docker'
        ]
...
def main():
    ...
    if args.json:
        ...
        print(f"📊 Health: {report['summary']['healthy_services']}/{report['summary']['total_services']} services ({report['summary']['health_percentage']:.1f}%)")
