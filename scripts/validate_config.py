...
class ConfigValidator:
    ...
    def __init__(self, env_file: str = ".env.production", config_file: str = "config/production.yaml"):
        """
    ...
    def validate_deployment_readiness(self):
        ...
        required_deployment_fields = ['release_version', 'deployment_date', 'git_commit']
...
def main():
    ...
    parser.add_argument("--check", action="store_true",
                       help="Just check if files exist")
