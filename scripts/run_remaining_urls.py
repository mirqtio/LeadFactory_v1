...
# Remaining URLs with corrected industries
REMAINING_URLS = [
    {
        "business_id": "invest_yakima",
        "business_name": "Invest in Yakima",
        "url": "https://www.investinyakima.com/",
        "vertical": "nonprofit",  # Changed from government to nonprofit
        "location": "Yakima, WA",
    },
    {
        ...
        "vertical": "finance",  # Changed from financial_services to finance
        "location": "Unknown",
    },
]
...
async def trigger_assessment(client: httpx.AsyncClient, business: Dict[str, Any]) -> str:
    ...
    payload = {
        ...
        "session_config": {"business_name": business["business_name"], "location": business["location"]},
    }
...
async def main():
    """Run pipeline for remaining URLs"""
