...
def check_test_coverage():
    ...
    test_domains = [
        "d0_gateway", "d1_targeting", "d2_sourcing", "d3_assessment",
        "d4_enrichment", "d5_scoring", "d6_reports", "d7_storefront",
        "d8_personalization", "d9_delivery", "d10_analytics", "d11_orchestration"
    ]
