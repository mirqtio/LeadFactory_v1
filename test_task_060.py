...
def test_task_060():
    ...
    from d8_personalization.models import (ContentStrategy, EmailContent,
                                           EmailContentType, EmailTemplate,
    ...
    click_rate = (
        subject_variant_data["click_count"] / subject_variant_data["open_count"]
    )
    conversion_rate = (
        subject_variant_data["conversion_count"] / subject_variant_data["sent_count"]
    )
    ...
    from d8_personalization.models import (PersonalizationToken,
    ...
    from d8_personalization.models import (SpamCategory, SpamScoreTracking,
    ...
    from d8_personalization.models import (ContentVariant, EmailGenerationLog,
    ...
    generation_log_data = {
        ...
        "input_data": {"business_name": "Test Business", "contact_name": "Jane Doe"},
        "personalization_strategy": PersonalizationStrategy.BUSINESS_SPECIFIC,
    ...
    from d8_personalization import (ContentVariant, EmailContent,
                                    EmailGenerationLog, EmailTemplate,
                                    PersonalizationToken,
                                    PersonalizationVariable, SpamScoreTracking,
                                    SubjectLineVariant)
