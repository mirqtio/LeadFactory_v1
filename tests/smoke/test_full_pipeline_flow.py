    ...
    def mock_coordinators(self):
        ...
        with patch("flows.full_pipeline_flow.AssessmentCoordinator") as mock_assessment, patch(
            ...
            mock_assessment_instance.execute_comprehensive_assessment = AsyncMock(
                return_value={
                    "pagespeed": {"performance_score": 85, "fcp": 1.2, "lcp": 2.5, "cls": 0.1, "tti": 3.8},
                    "tech_stack": {
                        "cms": "WordPress",
            ...
            mock_scorer_instance.calculate_score = Mock(
                return_value={
                    "overall_score": 78,
                    "tier": "B",  # Score 78 = B tier
                    "breakdown": {"performance": 85, "technical": 75, "seo": 70, "user_experience": 80},
                    "recommendations": ["Improve page load time", "Add structured data", "Enhance mobile experience"],
                }
            )
            ...
            mock_personalizer_instance.generate_email_content = AsyncMock(
                return_value={
            ...
            mock_email_instance.send_assessment_email = AsyncMock(
                return_value={"message_id": "test_message_123", "status": "sent"}
            )
