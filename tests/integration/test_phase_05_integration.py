...
from database.models import Business, APICost, DailyCostAggregate, Email, EmailStatus, Purchase, PurchaseStatus
...
class TestPhase05Integration:
    ...
    async def test_dataaxle_integration(self, mock_post, mock_get, test_business_data, mock_api_responses):
        ...
        with SessionLocal() as db:
            cost_record = db.query(APICost).filter_by(
                provider='dataaxle',
