...
def test_vertical_stats_parquet_exists():
    ...
    parquet_path = (
        ...
        / "data"
        / "processed"
        / "vertical_stats.parquet"
    )

    if not parquet_path.exists():
        pytest.skip(
            "vertical_stats.parquet not yet generated - run scripts/build_vertical_stats.py"
        )
    ...
    assert (
        ct_238.iloc[0]["median_receipts"] > 0
    ), "CT/238 should have positive median receipts"
