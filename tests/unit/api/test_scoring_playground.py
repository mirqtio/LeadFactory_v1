...
class TestGetCurrentWeights:
    ...
    def test_get_weights_from_yaml_file(self, mock_path_class):
        ...
        mock_weights_yaml = {
            "weights": {
                "revenue_potential": {
                    "weight": 0.25,
                    "description": "Company revenue potential"
                },
                "competitive_advantage": {
                    "weight": 0.20,
                    "description": "Market competitive advantage"
                },
                "market_position": {
                    "weight": 0.20,
    ...
    def test_get_default_weights_when_file_missing(self, mock_path_class):
        ...
        weight_names = {w.name for w in weights}
        expected_names = {
            "revenue_potential", "competitive_advantage", "market_position",
            "growth_trajectory", "operational_efficiency", "digital_presence"
        }
...
class TestSampleLeadAnonymization:
    ...
    def test_cache_expiration(self, mock_time):
        ...
        with patch('api.scoring_playground.logger'):
            from api.scoring_playground import get_sample_leads, CACHE_DURATION
            import api.scoring_playground
...
class TestErrorHandling:
    ...
    def test_missing_required_fields(self):
        ...
        with patch('api.scoring_playground.logger'):
            from api.scoring_playground import WeightVector, WeightImportRequest
...
class TestIntegration:
    ...
    def test_complete_weight_update_workflow(self, mock_path_class, mock_check_output, mock_run):
        ...
        with patch('api.scoring_playground.logger'):
            from api.scoring_playground import get_current_weights, ProposeDiffRequest, WeightVector
        ...
        mock_check_output.side_effect = [
            "diff --git a/d5_scoring/weights.yaml ...",
            "abc123def456"
        ]
