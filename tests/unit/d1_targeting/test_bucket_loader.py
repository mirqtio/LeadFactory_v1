...
class TestBucketFeatureLoader:
    ...
    def temp_seed_dir(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            geo_csv.write_text("""zip_code,city,state,affluence,agency_density,broadband_quality
...
""")
            ...
            vert_csv.write_text("""yelp_category,business_vertical,urgency,ticket_size,maturity
...
""")
    ...
    def test_get_business_buckets(self, temp_seed_dir):
        ...
        geo_bucket, vert_bucket = loader.get_business_buckets(
            '94105', ['lawyers']
        )
