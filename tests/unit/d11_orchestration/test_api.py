...
from d11_orchestration.models import (
    ...
    PipelineRunStatus, ExperimentStatus, PipelineType, VariantType
)
from d11_orchestration.schemas import (
    PipelineTriggerRequest, ExperimentCreateRequest, ExperimentVariantCreateRequest
)
...
class TestPipelineAPI:
    ...
    def test_trigger_pipeline(self, client, test_db):
        ...
        pipeline = test_db.query(PipelineRun).filter(
            PipelineRun.run_id == data["run_id"]
        ).first()
...
class TestExperimentAPI:
    ...
    def test_create_experiment(self, client, test_db):
        ...
        experiment = test_db.query(Experiment).filter(
    ...
    def test_delete_experiment(self, client, test_db):
        ...
        deleted = test_db.query(Experiment).filter(
