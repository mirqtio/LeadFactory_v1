...
class TestBatchRunnerIntegration:
    ...
    def test_batch_report_model(self):
        ...
        batch = BatchReport(name="Test Batch", template_version="v1", total_leads=10, created_by="test-user")
    ...
    def test_batch_report_lead_model(self):
        ...
        lead = BatchReportLead(batch_id="batch-123", lead_id="lead-456", order_index=0)
    ...
    def test_create_batch_schema(self):
        ...
        schema = CreateBatchSchema(lead_ids=["lead-1", "lead-2"], template_version="v1")
    ...
    def test_cost_preview_basic(self, mock_get_rates):
        ...
        mock_get_rates.return_value = {
            ...
            "providers": {"openai": {"cost_per_call": 0.30, "average_calls_per_lead": 1}},
            "discounts": {
                "volume_tiers": {
    ...
    def test_budget_validation(self, mock_get_rates):
        ...
        mock_get_rates.return_value = {"report_generation": {"base_cost": 0.10}, "providers": {}}
    ...
    def test_batch_filter_schema(self):
        ...
        schema = BatchFilterSchema(status=["running", "pending"], created_by="user-123")
    ...
    def test_error_response_schema(self):
        ...
        schema = ErrorResponseSchema(error="NOT_FOUND", message="Batch not found")
    ...
    def test_health_check_response_schema(self):
        ...
        schema = HealthCheckResponseSchema(
            status="ok", timestamp=datetime.utcnow(), database="connected", message="Batch runner service is healthy"
        )
    ...
    def test_lead_result_schema(self):
        ...
        schema = LeadResultSchema(lead_id="lead-123", status="completed", retry_count=0)
    ...
    def test_websocket_message_schema(self):
        ...
        schema = WebSocketMessageSchema(type="progress", batch_id="batch-123", timestamp="2025-01-14T10:00:00Z")
