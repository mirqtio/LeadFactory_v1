...
class TestDataAxleEnricher:
    ...
    async def test_enrich_business_success(self):
        ...
        mock_client.match_business = AsyncMock(return_value={
            "data": {
...
class TestHunterEnricher:
    ...
    async def test_find_email_success(self):
        ...
        mock_client.find_email = AsyncMock(return_value={
            "emails": [
                {
...
class TestEnrichmentCoordinatorIntegration:
    ...
    def test_initialize_phase05_enrichers(self, mock_gateway_factory):
        ...
        mock_gateway._is_provider_enabled.side_effect = lambda p: p in ["dataaxle", "hunter"]
    ...
    async def test_enrichment_fanout_pattern(self, mock_gateway_factory):
        ...
        mock_dataaxle.match_business = AsyncMock(return_value={
            "data": {
                "phone": "+1-555-123-4567",
                "website": "https://example.com",
                "employee_count": 50
        ...
        mock_hunter.find_email = AsyncMock(return_value={
            "emails": [{
    ...
    async def test_cost_tracking_integration(self, mock_gateway_factory):
        ...
        await coordinator.enrich_businesses_batch(
            businesses=businesses,
            sources=[EnrichmentSource.DATA_AXLE]
        )
