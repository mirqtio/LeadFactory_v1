...
from d9_delivery.delivery_manager import (
    DeliveryManager, DeliveryRequest, DeliveryResult,
    send_audit_email, create_delivery_request
)
...
from d9_delivery.models import EmailDelivery, DeliveryEvent, SuppressionList, DeliveryStatus, EventType
...
class TestDeliveryManager:
    ...
    def sample_personalization(self):
        ...
        return PersonalizationData(
            ...
            issues_found=[
                {"title": "Slow loading", "suggestion": "Optimize images"}
            ],
...
class TestUtilityFunctions:
    ...
    def test_check_email_suppression_utility(self):
        ...
        compliance_manager = ComplianceManager()
        compliance_manager.record_suppression(
            email="utility_suppressed@example.com",
            reason="test",
            source="utility_test"
        )
