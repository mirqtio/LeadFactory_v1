...
from d9_delivery.models import (
    EmailDelivery, BounceTracking, SuppressionList, DeliveryEvent,
    DeliveryStatus, BounceType, EventType, SuppressionReason
)
...
class TestEmailDelivery:
    ...
    def test_email_delivery_creation(self, db_session):
        ...
        # Test retrieval
        retrieved = db_session.query(EmailDelivery).filter_by(
            to_email="recipient@example.com"
        ).first()
    ...
    def test_event_types(self, sample_email_delivery, db_session):
        ...
        event_scenarios = [
            ...
            },
            {
                ...
                "data": {"event": "click", "url": "https://example.com", "timestamp": 1234567893},
                "url": "https://example.com"
            },
            {
                "type": EventType.BOUNCED.value,
                "data": {"event": "bounce", "reason": "User unknown", "timestamp": 1234567894}
            }
        ]
...
class TestModelIntegration:
    ...
    def test_complete_delivery_lifecycle(self, db_session):
        ...
        retrieved_delivery = db_session.query(EmailDelivery).filter_by(
            to_email="lifecycle@example.com"
        ).first()
    ...
    def test_bounce_and_suppression_workflow(self, db_session):
        ...
        suppressed = db_session.query(SuppressionList).filter_by(
            email="bounce@example.com"
        ).first()
