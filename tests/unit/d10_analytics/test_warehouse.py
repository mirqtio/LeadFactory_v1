...
from d10_analytics.models import (
    FunnelEvent, MetricSnapshot, FunnelConversion,
    FunnelStage, EventType, MetricType, AggregationPeriod
)
from d10_analytics.warehouse import (
    MetricsWarehouse, MetricsWarehouseConfig, WarehouseJobStatus,
    build_daily_metrics_for_date, backfill_recent_metrics, get_warehouse_health_check
)
...
class TestMetricsWarehouse:
    ...
    async def test_build_daily_metrics(self, warehouse, db_session, sample_funnel_events):
        ...
        metrics_count = db_session.query(MetricSnapshot).filter(
