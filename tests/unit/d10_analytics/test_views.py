...
from d10_analytics.models import FunnelEvent, FunnelStage, EventType
    ...
    def sample_funnel_data(self, db_session):
        ...
        for i, session_id in enumerate(sessions):
            ...
            event = FunnelEvent(
                ...
                cost_cents=100,
                success=True,
                occurred_at=datetime.combine(base_date, datetime.min.time()).replace(tzinfo=timezone.utc)
            )
            events.append(event)
