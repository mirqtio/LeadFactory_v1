...
class TestGatewayClientFactory:
    ...
    def test_invalid_provider_raises_error(self, factory):
        ...
        assert "Available: yelp, pagespeed, openai, sendgrid, stripe" in str(exc_info.value)
    ...
    def test_get_client_status(self, factory):
        ...
        assert sorted(status['registered_providers']) == ['openai', 'pagespeed', 'sendgrid', 'stripe', 'yelp']
