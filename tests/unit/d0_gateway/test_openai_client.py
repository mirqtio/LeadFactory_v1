...
class TestOpenAIClient:
    ...
    async def test_website_performance_analysis(self, openai_client):
        ...
        pagespeed_data = {
            ...
            "lighthouseResult": {
                ...
                "audits": {
                    "largest-contentful-paint": {"score": 0.6, "displayValue": "3.2 s"},
                    "cumulative-layout-shift": {"score": 0.8, "displayValue": "0.15"},
                },
            },
        }
    ...
    async def test_email_content_generation(self, openai_client):
        ...
        # Mock website issues
        website_issues = [
            {"issue": "Poor page load speed", "impact": "high"},
            {"issue": "Missing meta descriptions", "impact": "medium"},
            {"issue": "Low accessibility score", "impact": "medium"},
        ]
