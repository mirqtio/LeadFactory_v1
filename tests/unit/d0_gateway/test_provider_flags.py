...
class TestProviderFeatureFlags:
    ...
    def test_google_places_respects_enable_flag(self):
        ...
        with patch("core.config.get_settings") as mock_settings:
            mock_settings.return_value = MagicMock(
                enable_gbp=False, use_stubs=True, stub_base_url="http://localhost:5010"
            )
    ...
    def test_google_places_uses_real_url_without_stubs(self):
        ...
        with patch("core.config.get_settings") as mock_settings:
            mock_settings.return_value = MagicMock(
                enable_gbp=True, use_stubs=False, get_api_key=MagicMock(return_value="real-api-key")
            )
    ...
    def test_pagespeed_respects_enable_flag(self):
        ...
        with patch("core.config.get_settings") as mock_settings:
            mock_settings.return_value = MagicMock(enable_pagespeed=False, use_stubs=True)
    ...
    def test_sendgrid_respects_enable_flag(self):
        ...
        with patch("core.config.get_settings") as mock_settings:
            mock_settings.return_value = MagicMock(enable_sendgrid=False, use_stubs=True)
    ...
    def test_openai_respects_enable_flag(self):
        ...
        with patch("core.config.get_settings") as mock_settings:
            mock_settings.return_value = MagicMock(enable_openai=False, use_stubs=True)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                "enable_pagespeed",
                PageSpeedClient,
                "PageSpeed client initialized but ENABLE_PAGESPEED=false",
            ),
