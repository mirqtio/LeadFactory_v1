...
class TestReportGenerator:
    ...
    async def test_generate_html_only(self):
        ...
        mock_template_engine.render_template.assert_called_with(
            "custom_template", mock_template_engine.create_template_data.return_value
        )
    ...
    def test_get_status(self):
        ...
        mock_template_engine = Mock()
        mock_template_engine.list_templates.return_value = [
            "basic_report",
            "minimal_report",
        ]
        ...
        assert status["template_engine"]["available_templates"] == [
            "basic_report",
            "minimal_report",
        ]
