...
class TestAuditLogLeadModel:
    ...
    def test_audit_log_all_actions(self, db_session, created_lead):
        ...
        for action in AuditAction:
            audit_log = AuditLogLead(
                lead_id=created_lead.id, action=action, user_id="test_user", checksum="test_checksum"
            )
    ...
    def test_audit_log_minimal_data(self, db_session, created_lead):
        ...
        audit_log = AuditLogLead(lead_id=created_lead.id, action=AuditAction.DELETE, checksum="minimal_checksum")
    ...
    def test_audit_log_timestamp_auto_generation(self, db_session, created_lead):
        ...
        audit_log = AuditLogLead(lead_id=created_lead.id, action=AuditAction.CREATE, checksum="timestamp_test")
    ...
    def test_audit_log_id_generation(self, db_session, created_lead):
        ...
        audit_log = AuditLogLead(lead_id=created_lead.id, action=AuditAction.CREATE, checksum="id_test")
