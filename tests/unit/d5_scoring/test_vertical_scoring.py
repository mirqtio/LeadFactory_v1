...
class TestTask047AcceptanceCriteria:
    ...
    def test_restaurant_rules_work(self):
        ...
        assert 'restaurant_operations' in vertical_info['override_components'], "Should have restaurant-specific components"
    ...
    def test_override_logic_correct(self):
        ...
        if 'location_data' in component_explanations:
            ...
            assert location_status in ['overridden', 'vertical_specific'], "Location should be overridden for restaurants"
