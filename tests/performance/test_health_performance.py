...
class TestHealthEndpointPerformance:
    ...
    def test_concurrent_request_performance(self):
        ...
        for num_concurrent in [5, 10, 20]:
            ...
            assert avg_internal < 100, f"Average internal time {avg_internal:.2f}ms exceeds 100ms at concurrency {num_concurrent}"
            assert max_internal < 100, f"Max internal time {max_internal:.2f}ms exceeds 100ms at concurrency {num_concurrent}"
