...
class TestBusinessGenerator:
    ...
    def test_restaurant_scenario(self):
        ...
        assert any(cat in ["restaurant", "italian", "chinese", "mexican", "pizza", "cafe", "bistro"] 
    ...
    def test_healthcare_scenario(self):
        ...
        assert any(cat in ["medical", "dental", "therapy", "clinic", "hospital"] 
                  for cat in business.categories)
    ...
    def test_professional_services_scenario(self):
        ...
        assert any(cat in ["legal", "accounting", "consulting", "financial", "insurance"] 
                  for cat in business.categories)
