...
class BusinessGenerator:
    ...
    def _setup_profiles(self):
        ...
        self.profiles = {
            BusinessScenario.RESTAURANTS: BusinessProfile(
                ...
                business_status_weights={
                    "OPERATIONAL": 0.85,
                    "TEMPORARILY_CLOSED": 0.10,
                    "PERMANENTLY_CLOSED": 0.05,
                },
            ),
            BusinessScenario.RETAIL: BusinessProfile(
                ...
                business_status_weights={
                    "OPERATIONAL": 0.90,
                    "TEMPORARILY_CLOSED": 0.08,
                    "PERMANENTLY_CLOSED": 0.02,
                },
            ),
            ...
            BusinessScenario.PROFESSIONAL_SERVICES: BusinessProfile(
                ...
                business_status_weights={
                    "OPERATIONAL": 0.92,
                    "TEMPORARILY_CLOSED": 0.05,
                    "PERMANENTLY_CLOSED": 0.03,
                },
            ),
    ...
    def generate_business(self, scenario: BusinessScenario, business_id: str | None = None) -> Business:
    ...
    def generate_businesses(self, count: int, scenarios: list[BusinessScenario] | None = None) -> list[Business]:
