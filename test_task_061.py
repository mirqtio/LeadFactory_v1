...
def test_task_061():
    ...
    from d8_personalization.models import (EmailContentType,
                                           PersonalizationStrategy)
    from d8_personalization.subject_lines import (GenerationStrategy,
    ...
    request = SubjectLineRequest(
        ...
        business_data={"name": "Acme Restaurant LLC", "category": "restaurant"},
    ...
    personalization_score = generator._calculate_personalization_score(
    ...
    perf_templates = {
        ...
        "token_config": {"business_name": {"default": "your business"}},
