...
class EmailDelivery(Base):
    ...
    delivery_events = relationship("DeliveryEvent", back_populates="email_delivery", 
...
class BounceTracking(Base):
    ...
    email_delivery_id = Column(Integer, ForeignKey('email_deliveries.id'), 
    ...
    # Timestamps
    bounced_at = Column(DateTime(timezone=True), nullable=False, 
                       default=lambda: datetime.now(timezone.utc), index=True)
    created_at = Column(DateTime(timezone=True), nullable=False,
...
class DeliveryEvent(Base):
    ...
    __table_args__ = (
        UniqueConstraint('email_delivery_id', 'event_type', 'event_timestamp',
